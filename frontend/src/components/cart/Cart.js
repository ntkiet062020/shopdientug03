                        ...
                        <div className="col-md-12">
                            <div className="card">
                                ...
                                <div className="card-body cart">
                                    <div className="col-sm-12 empty-cart-cls text-center"> <img src="https://cdn-icons-png.flaticon.com/256/1170/1170627.png" width={130} height={130} className="img-fluid mb-4 mr-3" alt='' />
                                        <h3><strong>Giỏ hàng của bạn trống</strong></h3>
                                        <h4>Hãy khám phá các sản phẩm tuyệt vời của chúng tôi và thêm những món đồ yêu thích vào giỏ hàng để bắt đầu trải nghiệm mua sắm thú vị!</h4> <Link to="/" className="btn btn-primary cart-btn-transform m-3" data-abc="true">Tiếp tục mua sắm</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
